...
does not need them yet. Saved conversations are listed at `/conversations`;
opening one gives it its own tab at `/chat/<id>`, as papers get, leaving the
homepage's chat untouched.
