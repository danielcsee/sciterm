"""OpenAI integration: intent routing, cited answers, the entities they name,
and plain-language definitions of highlighted phrases."""
...
from api.llm.definition import define_term
